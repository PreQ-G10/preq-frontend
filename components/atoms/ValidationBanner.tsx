...
export function ValidationBanner({ count, onPress }: ValidationBannerProps) {
  return (
    <TouchableOpacity testID="validation-banner" style={styles.container} onPress={onPress} activeOpacity={0.85}>
      <View style={styles.iconContainer}>
        <Ionicons name="checkmark-circle-outline" size={22} color={Colors.primary} />
      </View>
      <View style={styles.textContainer}>
        <AppText variant="label" color="primary">Precios para validar</AppText>
        <AppText testID="validation-banner-message" variant="bodySmall" color="secondary">
          {count === 1
